...
// we're looking to make an login to request to the module that manages users 
@Service
public class AuthMqService {
    ...
    public AuthMqService(RabbitTemplate rabbitTemplate, ObjectMapper jsonMapper, MqResponseRepository mqResponseRepository) {
